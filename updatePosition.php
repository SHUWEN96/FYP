...
$app_post1 = $_POST['app_post1'];
    ...
    if(empty($faculty) || empty($app_post1) ) {                
        if(empty($faculty)) {
            echo "<script>alert('Faculty field is empty.')</script>";
        }
        
        if(empty($app_post1)) {
            echo "<script>alert('Applicant position 1 field is empty.')</script>";
		}	 
...
mysqli_select_db($link,"final_year_project") or die("Cannot connect to database");
	...
	$sql = "SELECT * FROM position WHERE Choose_Position_Id=$Choose_Position_Id";
...
?>
    ...
    <div id="right-panel" class="right-panel">
       ...
       <div class="breadcrumbs">
		...
		<form class="form-inline" action="updatePosition.php?Choose_Position_Id=<?php echo $Choose_Position_Id?>" method="post" enctype="multipart/form-data" >
        <div class="content mt-3">
								...
								<input type="hidden" class="form-control" name="user_Ic" id="disabledInput" type="text" placeholder="<?php echo $_SESSION['SESS_NOIC'] ?>" readonly>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col"><select id="faculty" name="faculty" class="form-control" value="<?php echo $faculty;?>" required >
                                                                 <option value=""></option>
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col"><select id="app_post1" class="form-control" value="<?php echo $app_post1;?>" name="app_post1">
                                                 <option value=""></option>
			...
			<a style="border-radius: 8px;" class="btn btn-primary" href="i.php">Back</a></div>
        </div><!-- .content -->
