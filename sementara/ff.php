...
?>
						...
						<div class="animated">
							...
							<div class="card">
								<div class="card-header">
									...
									<td ><a href="verifyKoko.php?Cocuriculum_Id=<?php echo $row["Cocuriculum_Id"]?>">Verify</a> 
									</td>
								</div>
								<div class="card-body">
										   <button style="border-radius: 8px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#mediumModal" <?php if ($rowlist["Cocuriculum_checklist"] = '1'){ ?> disabled <?php   } ?> >Add New Data</button>
							  <br/>
							  <br/>
											<table class="table">
												<tbody>
        ...
        while($rowlist = $reslist->fetch_assoc()) {        
          ...
          echo "<td scope='col' ><a href=\"editkoko.php?Cocuriculum_Id=$rowlist[Cocuriculum_Id]\">Edit</a> | <a href=\"deletekoko.php?Cocuriculum_Id=$rowlist[Cocuriculum_Id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";       
        }
        ?>
