...
<!-- Left Panel -->
  ...
  /Polytechnic</a></li>
    ...
    <form class="form-inline" id="insert_form" method="post" action="insert.php" enctype="multipart/form-data" >
            ...
            <div class="animated">
                ...
                <div class="card">
				   ...
				   <option value="">Select Level</option>
                    ...
                    <option value="2">SRP/PMR</option>
                    <option value="3">SPM/SPVM</option>
					<option value="4">STPM/STAM</option>
					<option value="5">University/College/Polytechnic</option>
					
                    </select>
					
					<select name='edu' class="form-control">
					<?php 
					$sql = "SELECT * FROM subject where type_id = 1";
					while($result = mysqli_multi_query($link, $sql)){
					?>
					...
					<br/>
										...
										<tr>
                                             <th scope="col"><center><input class="form-control" type="text" id="school" name="school" ></center></th>
                                             <th scope="col" ><center><input class="form-control" type="number" name="year" min="1990" max="2018" /></center></th>
                                             <th scope="col"><center><input class="form-control" type="text" id="level" name="level" ></center></th>
                                            
                                        </tr>
										
										<tr>
                                             <th scope="col"><center><label for="cert">Attach Result Certificate</label></center></th>
                                             <th colspan="2" scope="col" ><center><input class="form-control" type="file" name="cert" ></th>
										...
										<tr>
                                             ...
                                             <th scope="col"><center><button type="button" name="add" class="btn btn-success btn-sm add">Add</button></center></th>
...
$(document).ready(function(){
 ...
 $(document).on('click', '.add', function(){
  var html = '';
  html += '<tr>';
  html += '<td align="center"><input type="text" name="subject[]" class="form-control" /></td>';
  html += '<td align="center"><select name="gred[]" class="form-control"><option value="">Select Gred</option><?php echo fill_unit_select_box($connect); ?></select></td>';
  html += '<td align="center"><button type="button" name="remove" class="btn btn-danger btn-sm remove">Delete</span></button></td></tr>';
...
$('#verify').click(function(){
	...
	if(page_type==1||page_type==2||page_type==3||page_type==4){
