...
<body>
  ...
  /Polytechnic</a></li>
    ...
    <form class="form-inline" action="insert2.php" id="insert_form2" method="post" enctype="multipart/form-data" id="insert_form1">
            ...
            <div class="animated">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <strong class="card-title" style="font-size:px;">c. SPM/SPVM</strong>
                    </div>
                    <div class="card-body">
...
$(document).ready(function(){
 ...
 $(document).on('click', '.add', function(){
  var html = '';
  html += '<tr>';
  html += '<td><input type="text" name="subject2[]" class="form-control subject2"/></td>';
  html += '<td><select name="gred2[]" class="form-control gred2"><option value="">Select Gred</option><?php echo fill_unit_select_box($connect); ?></select></td>';
