...
<body>
  ...
  /Polytechnic</a></li>
    ...
    <form class="form-inline" action="insert1.php" method="post" enctype="multipart/form-data" id="insert_form1">
            ...
            <div class="animated">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <strong class="card-title" style="font-size:px;">b. SRP/PMR</strong>
                    </div>
                    <div class="card-body">
...
$(document).ready(function(){
 ...
 $(document).on('click', '.add', function(){
  var html = '';
  html += '<tr>';
  html += '<td><input type="text" name="subject1[]" class="form-control subject1"/></td>';
  html += '<td><select name="gred1[]" class="form-control gred1"><option value="">Select Gred</option><?php echo fill_unit_select_box($connect); ?></select></td>';
  ...
  if(error == '')
  {
   $.ajax({
    ...
    success:function(data)
    {
     if(data == 'ok')
     {
      $('#dynamic_field1').find("tr:gt(0)").remove();
