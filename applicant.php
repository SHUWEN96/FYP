        ...
        <header id="header" class="header">
            ...
            <div class="header-menu">
                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-notification">
                            ...
                            <div class="dropdown-menu" aria-labelledby="notification">
                                ...
                                <a class="dropdown-item media bg-flat-color-1" href="applicantNotify.php">
                ...
                <div class="col-sm-5">
					...
					<div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						 <a class="nav-link" href="changePassmain.php">Change Password</a>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                               <p ><center><p>Welcome <b> <?php echo $_SESSION['SESS_NOIC']?></b> you already login as <b><?php echo $_SESSION['selected_val']; ?></b>.</p></center></p>
                            </div>
                         </div>  
                    </div>
				</div>
