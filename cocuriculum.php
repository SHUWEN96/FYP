            ...
            <div class="animated">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
							  ...
							  <button style="border-radius: 8px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#mediumModal" <?php echo $row["Cocuriculum_checklist"] =1? "disabled ":""?> >Add New Data</button>
							  <br/>
							  <br/>
