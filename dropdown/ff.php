                                ...
                                <table class="table">
                                    <tbody>
									 <tr>
                                            ...
                                            <th scope="col"><select id='app_post1' class="form-control" name='app_post'>
											 ...
											 <th><button id='verify' class="btn btn-success">Submit</button> 
                                        </tr>
...
$('#verify').click(function(){
	...
	if(page_type==1){
		...
		window.location.href='hi1.php'
	}else if(page_type==3){
		window.location.href='hi3.php'
	}
